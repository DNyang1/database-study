...
-- 정답: 
SELECT name, category, stock FROM products WHERE category = '생활용품' AND price >= 100000 OR stock >= 50;
...
-- 정답:
SELECT name, stock, price * 0.7 FROM products WHERE category = '전자기기' AND stock <= 10;
...
-- 정답:
SELECT price * stock AS '총판매액' FROM products
