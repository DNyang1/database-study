-- Active: 1758675041396@@127.0.0.1@3306@market
-- 셀프체크
...
SELECT SUM(od.count * p.price) / (SELECT COUNT(*) FROM users)
...
-- 1은 결제에 참여하지 않은 사람포함 2는 진짜 결제한 사람만 집계
